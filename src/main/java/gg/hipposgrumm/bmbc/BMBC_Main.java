...
import gg.hipposgrumm.bmbc.blocks.BlockEntityRegister;
...
import net.matty.bmbc.creativemode_tab.ModFluidsCreativeModeTab;
import net.matty.bmbc.creativemode_tab.ModResourcesCreativeModeTab;
...
public class BMBC_Main {
    ...
    //public static final RegistryObject<Block> ALLOY_FURNACE = BLOCKS.register("alloy_furnace", () -> new AlloyFurnaceBlock(BlockBehaviour.Properties.of(Material.METAL).strength(3f).requiresCorrectToolForDrops().noOcclusion())); // TODO: Set this to the correct material later.
    ...
    ////public static final RegistryObject<BlockEntityType<AlloyFurnaceBlockEntity>> ALLOY_FURNACE_BE = BLOCK_ENTITIES.register("alloy_furnace", () -> BlockEntityType.Builder.of(AlloyFurnaceBlockEntity::new, ModBlocks.ALLOY_FURNACE.get()).build(null));
...
//
    ...
    public static class ClientModEvents {
        ...
        public static void registerBlockRender(EntityRenderersEvent.RegisterRenderers event) {
            //event.registerBlockEntityRenderer(BlockEntityRegister.ALLOY_FURNACE.get(), AlloyFurnaceBlockEntityRenderer::new);
        }
    }

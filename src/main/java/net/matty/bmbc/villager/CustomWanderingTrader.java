...
// This wandering trader class basically is a copy of the actually wandering trader class

public class CustomWanderingTrader extends AbstractVillager {
    private static final int NUMBER_OF_TRADE_OFFERS = 50;
    @Nullable
    private BlockPos wanderTarget;
    private int despawnDelay;

    public CustomWanderingTrader(EntityType<? extends CustomWanderingTrader> pEntityType, Level pLevel) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new AvoidEntityGoal<>(this, Zombie.class, 8.0F, 0.58D, 0.58D));
        this.goalSelector.addGoal(1, new AvoidEntityGoal<>(this, Evoker.class, 12.0F, 0.6D, 0.6D));
        this.goalSelector.addGoal(1, new AvoidEntityGoal<>(this, Vindicator.class, 8.0F, 0.6D, 0.6D));
        this.goalSelector.addGoal(1, new AvoidEntityGoal<>(this, Vex.class, 8.0F, 0.6D, 0.6D));
        this.goalSelector.addGoal(1, new AvoidEntityGoal<>(this, Pillager.class, 15.0F, 0.6D, 0.6D));
        this.goalSelector.addGoal(1, new AvoidEntityGoal<>(this, Illusioner.class, 12.0F, 0.6D, 0.6D));
        this.goalSelector.addGoal(1, new AvoidEntityGoal<>(this, Zoglin.class, 10.0F, 0.5D, 0.5D));
        this.goalSelector.addGoal(1, new AvoidEntityGoal<>(this, Skeleton.class, 8.0F, 0.58D, 0.58D));
        this.goalSelector.addGoal(1, new PanicGoal(this, 0.5D));
        this.goalSelector.addGoal(1, new LookAtTradingPlayerGoal(this));
        this.goalSelector.addGoal(2, new CustomWanderingTrader.WanderToPositionGoal(this, 20.0D, 0.35D));
        this.goalSelector.addGoal(4, new MoveTowardsRestrictionGoal(this, 0.35D));
        this.goalSelector.addGoal(8, new WaterAvoidingRandomStrollGoal(this, 0.40D));
        this.goalSelector.addGoal(9, new InteractGoal(this, Player.class, 3.0F, 1.0F));
        this.goalSelector.addGoal(10, new LookAtPlayerGoal(this, Mob.class, 14.0F));
    }
    ...
    @Override
    protected void rewardTradeXp(MerchantOffer pOffer) { // Look at what these values mean
    ...
    class WanderToPositionGoal extends Goal {
        final CustomWanderingTrader trader;
        final double stopDistance;
        final double speedModifier;

        WanderToPositionGoal(CustomWanderingTrader pTrader, double pStopDistance, double pSpeedModifier) {
            this.trader = pTrader;
        ...
        public void stop() {
            ...
            CustomWanderingTrader.this.navigation.stop();
        }
        ...
        public void tick() {
            BlockPos blockpos = this.trader.getWanderTarget();
            if (blockpos != null && CustomWanderingTrader.this.navigation.isDone()) {
                if (this.isTooFarAway(blockpos, 10000.0D)) {
                    ...
                    CustomWanderingTrader.this.navigation.moveTo(vec31.x, vec31.y, vec31.z, this.speedModifier);
                } else {
                    CustomWanderingTrader.this.navigation.moveTo((double) blockpos.getX(), (double) blockpos.getY(), (double) blockpos.getZ(), this.speedModifier);
                }
            }

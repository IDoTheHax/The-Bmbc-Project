...
public class AlloyFurnaceMenu extends AbstractContainerMenu {
    ...
    public AlloyFurnaceMenu(int id, Inventory inv, BlockEntity entity, ContainerData data) {
        ...
        this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(handler -> {
            this.addSlot(new SlotItemHandler(handler, 0, 35, 9));
            this.addSlot(new SlotItemHandler(handler, 1, 53, 9));
    ...
    public int getScaledProgress() {
        ...
        int progressArrowSize = 7; // This is the height in pixels of your arrow

...
import net.matty.bmbc.screen.renderer.EnergyInfoArea;
import net.matty.bmbc.screen.renderer.FluidTankRenderer;
import net.matty.bmbc.util.MouseUtil;
...
public class PressureVesselScreen extends AbstractContainerScreen<PressureVesselMenu> {
    ...
    public PressureVesselScreen(PressureVesselMenu menu, Inventory inventory, Component component) {

//package net.matty.bmbc.item.batteries;
//
//import net.matty.bmbc.energy.BmbcEnergyItemStorage;
...
//public class BmbcEnergyItem extends Item {
//    private final int maxEnergy;
//    private final int maxTransfer;
//
//    @Deprecated
//    public BmbcEnergyItem(Properties properties, int maxEnergy, int maxTransfer){
//        super(properties);
...
//                    return LazyOptional.of(() -> new BmbcEnergyItemStorage(itemStack, maxEnergy, maxTransfer)).cast();
//                }

...
public enum ModArmorMaterials implements ArmorMaterial {
    HAZMAT("hazmat", 27, Util.make(new EnumMap<>(ArmorItem.Type.class), (p_266655_) -> {
    ...
    }), 19, SoundEvents.ARMOR_EQUIP_NETHERITE, 4.0F, 0.1F, () -> {
        return Ingredient.of(ModItems.NBC_FABRIC.get());
    });

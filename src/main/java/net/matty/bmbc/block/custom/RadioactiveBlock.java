        ...
        return player.getCapability(ForgeCapabilities.ITEM_HANDLER)
                .map(itemHandler -> {
                    if (itemHandler instanceof IItemHandlerModifiable) {
                        IItemHandlerModifiable modifiableHandler = (IItemHandlerModifiable) itemHandler;
                        ...
                        if (helmet.getItem() == ModArmorItems.NBC_HAZMAT_MASK.get() && // This is for testing purposes only
